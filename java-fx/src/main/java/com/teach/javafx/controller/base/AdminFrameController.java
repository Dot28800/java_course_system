...
public class AdminFrameController {
    ...
    private AdminFrameController.ChangePanelHandler handler= null;
    @FXML
    ...
    public void onLeaveButton(){
        changeContent("leave/leave-table-panel","请假记录");
    }
    @FXML
    ...
    public void onScore(){
        changeContent("score/score-table-panel","考试信息");
    }
    public void onMark(){
        changeContent("mark/mark-panel","成绩管理");
    }
    public void onRank(){
        changeContent("mark/totalRank","成绩排名");
    }
    public void onStatistic(){
        changeContent("statistic/statistic","学生信息统计");
    }
    ...
    public void initialize() {
        ...
        startThread();
        //newThread();
        DataResponse response=HttpRequestUtil.request("/api/leave/searchLeave",new DataRequest());
        String msg= response.getMsg();
        if(msg.equals("yes")){
            MessageDialog.showDialog("检测到有未处理的学生请假申请，请尽快处理");
            /*int jet=MessageDialog.choiceDialog("检测到有学生请假申请，是否立即前往处理？");
            if(jet != MessageDialog.CHOICE_NO) {
                return;
            }
            changeContent("leave/leave-table-panel","请假记录");*/
        }
