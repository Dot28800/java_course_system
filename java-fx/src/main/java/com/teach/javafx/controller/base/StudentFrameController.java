...
public class StudentFrameController {
    ...
    public Button ButtonClick3;
    public Button ButtonClick4;
    public Button ButtonClick5;
    ...
    private StudentFrameController.ChangePanelHandler handler= null;
    @FXML
    public void onAttendanceButton(){
        changeContent("courseAttendance/course-attendance-panel","课程考勤");
    }
    @FXML
    public void onHomeworkButton(){
        changeContent("homeWork/work-panel","作业信息");
    }
    @FXML
    public void onLeaveButton(){
        changeContent("leave/student-leave","我的请假");
    }
    @FXML
    public void onPasswordButton(){
        changeContent("base/password-panel","修改密码");
    }

    public void onScore(){
        changeContent("score/student-score","我的考试");
    }
    public void onEditPassword(){
        changeContent("secureProblem/editPassword","密码重置");
    }
    public void onMark(){
        changeContent("mark/student-mark","成绩管理");
    }
    public void onRank(){
        changeContent("mark/totalRank","成绩排名");
    }
    public void onResume(){
        changeContent("resume/resume-panel","个人简介");
    }
    ...
    private void reSetTimer(){
        ...
        javax.swing.Timer timeAction = new Timer(1000, new ActionListener() {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                while(true) {
                    ...
                    Platform.runLater(() -> {
                        timeField.setText( DateTimeTool.parseDateTime(new Date(), "yyyy-MM-dd HH:mm:ss"));
                    });
                }
            }
        });
    ...
    public void initMenuBar(List<Map> mList){
        ...
        Map m;
        List<Map> sList;
        for(i = 0; i < mList.size();i++) {//从后端数据库里面传输过来的数据中获取menu数据表里面的标签名
            m = mList.get(i);//获取menu列表里面每一个map键值对
            sList = (List<Map>)m.get("sList");
            menu = new Menu();
    ...
    public void initialize() {
        ...
        //contentTabPane.setStyle("-fx-background-image: url('坤坤.jpg'); -fx-background-repeat: no-repeat; -fx-background-size: cover;");
        ...
        Map data= (Map) userResponse.getData();//inline选择器
    ...
    public void onMyself(){
        changeContent("student-own-panel","个人信息");
    }
    public void onFamily(){
        changeContent("familyMember/student-Member-panel","我的家庭");
    }

    public void onPre(){
        changeContent("preInformation/student-pre-panel","我的过往");
    }
    ...
    protected void logout(){
        FXMLLoader fxmlLoader = new FXMLLoader(MainApplication.class.getResource("base/login.fxml"));
        try {
...
//        Scene scene = node.getScene();
    ...
    protected  void doNewCommand(){
        ...
        if(c == null)
            return;
        c.doNew();*/
        ToolController c=new StudentController();
        c.doNew();
    }
    /**
