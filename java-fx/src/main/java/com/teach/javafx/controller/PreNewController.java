...
public class PreNewController {
    ...
    public void showDialog(Map data) {
        if(data == null) {
            ...
            preSchoolField.setText("");
            preScoreField.setText("");
            preRankField.setText("");
            preHonorField.setText("");
            /*timeField.setText("");
            flagField.setText("");*/
        }else {
    ...
    public void okButtonClick(){
        ...
        preInformationController.doNewClose("ok",data);

    }
    @FXML
    public void cancelButtonClick(){
        preInformationController.doNewClose("cancel",null);
