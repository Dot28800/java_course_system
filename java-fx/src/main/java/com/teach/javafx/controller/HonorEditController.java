...
public class HonorEditController {
    ...
    public HonorTableController getHonorTableController() {
        return honorTableController;
    }
    ...
    public void okButtonClick(){
        ...
        data.put("host",host);
        data.put("type",type);
        honorTableController.doEditClose("ok",data);

    }
    @FXML
    public void cancelButtonClick(){
        honorTableController.doEditClose("cancel",null);
